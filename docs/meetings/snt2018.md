...
![snt2018.png](snt2018.png)

- Location: [Prague](http://en.wikipedia.org/wiki/Prague)
- Date: 23. 8. - 26. 8. 2018
- Organizer: [Silicon Hill](../networks/prague_silicon-hill.md)
- Capacity: 80 beds
...
![](snt2018/photos/final_photo-2.jpg){ .align-left width="500" }
![](snt2018/photos/final_photo-1.jpg){ width="500" }
...
| Elevenses | \-- | | | |
| Lunch | \-- | | Chicken soup<br>Goulash w/ dumplings | Baquettes 2Go [1](https://www.bbbox.cz/en/box-6) [2](https://www.bbbox.cz/en/fish-vege) [3](https://www.bbbox.cz/en/meat-box-sunka-pastrami-caesar-roastbeef) |
...
![Ticket vending
machine](snt2018/guides/vending_machine.jpg){ width="100" }
![Ticket validating
machine](snt2018/guides/ticket_validator.jpg){ width="130" } ![Ticket validating
machine](snt2018/guides/validator_metro.jpg){ width="180" }
...
transfer](snt2018/guides/hl-nadr-tram.png){ width="120" }
![Švandovo divadlo bus
transfer](snt2018/guides/svandovo-divadlo.png){ width="170" }
...
![Praha Florenc tram
transfer](snt2018/guides/florenc-tram-2.png){ width="140" }
![Praha Florenc Metro
transfer](snt2018/guides/florenc-metro.png){ width="220" }
...
SNT18](snt2018/guides/strahov2.png){ .align-center width="400" }
