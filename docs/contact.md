...
### Matrix
Hackint operates a Matrix transport for their IRC channels. You can connect to our channel using the room [#studnetze:hackint.org](https://matrix.to/#/#studnetze:hackint.org) via Matrix.
